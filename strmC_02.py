...
def chain_task():
    ...
    while True:
        ...
        if my_chain is None:
            ...
            print(f'chain_sym_list type: {type(chain_sym_list)}, data:\n{chain_sym_list}')
            # Future: build_add_opt_request(CREDS, chain_sym_list) and enqueue_ws_message(...)

            # chain_sym_list = ['SPXW  260724C07450000', 'SPXW  260724P07450000']
            # chain_sym_list = ['SPXW  260724C07450000']
            # print(f'raw list:{chain_sym_list}')

            # normalized_list = normalize_option_symbols(chain_sym_list)
